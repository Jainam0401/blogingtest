  ...
  return (
    <section
      ...
      className={cn(
        ...
        "bg-gradient-to-r from-[#7393F2] md:from-[80%] from-[20%]  to-[#BFEDFF] to-[100%] md:to-[100%]",
        className
      )}
    >
      <div className="mx-auto py-10 md:py-12 px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col gap-6 items-start justify-between md:flex-row md:items-center">
          ...
          <div className="w-full md:w-auto">
            <form
              className="flex w-full flex-col sm:flex-row items-center gap-3 rounded-lg bg-white p-2 shadow-md"
              onSubmit={(e) => e.preventDefault()}
            >
              <input
                type="email"
                className="h-11 w-full sm:w-auto flex-1 rounded-md px-4 text-sm outline-none"
                placeholder="Email Address"
                aria-label="Email Address"
              />
              <button
                type="submit"
                className="h-11 w-full sm:w-auto rounded-md px-5 text-sm font-semibold text-white bg-gradient-to-r from-sky-500 to-blue-600 hover:opacity-90"
              >
                Subscribe
              </button>
            </form>
